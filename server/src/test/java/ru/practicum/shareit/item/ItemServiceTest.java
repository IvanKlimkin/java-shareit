...
class ItemServiceTest {
    ...
    void getAllTest() {
        ...
        when(bookingRepository.findTopByItemAndStartAfter(
                any(), any(), any()))
                .thenReturn((booking1));
        when(bookingRepository.findTopByItemAndEndBefore(
                any(), any(), any()))
                .thenReturn(booking2);
    ...
    void addCommentTest() {
        ...
        when(bookingRepository.findBookingByBookerAndItemAndStateAndEndIsBefore(
                any(), any(), any(), any()))
                .thenReturn(booking1);
