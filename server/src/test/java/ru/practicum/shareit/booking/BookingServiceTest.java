...
class BookingServiceTest {
    ...
    void beforeEach() {
        ...
        booking = new Booking(1L, testTime, testTime.plusMinutes(5), item, user, State.WAITING);
        bookingApproved = new Booking(1L, testTime, testTime.plusMinutes(5), item, user, State.APPROVED);
        booking2 = new Booking(2L, testTime.plusMinutes(15), testTime.plusMinutes(20), item, user, State.APPROVED);
    ...
    void getAllUserBookingsWrongUserTest() {
        ...
        ServerException exp = assertThrows(ServerException.class, () -> {
            bookingService.getAllUserBookings(1L, State.WAITING, pageRequest);
        });
    ...
    void getAllUserItemBookingsWrongUserTest() {
        ...
        ServerException exp = assertThrows(ServerException.class, () -> {
            bookingService.getAllUserItemBookings(1L, State.WAITING, pageRequest);
        });
