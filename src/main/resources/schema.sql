...
(
    ...
    CONSTRAINT fk_user FOREIGN KEY (owner_id) REFERENCES users ON DELETE CASCADE
    --CONSTRAINT fk_userRequested
    --  FOREIGN KEY (request_id) REFERENCES users ON DELETE CASCADE
);
